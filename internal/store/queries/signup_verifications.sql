-- name: UpsertSignupVerificationByEmail :one
...
-- name: UpsertSignupVerificationByPhone :one
INSERT INTO signup_verifications (id, email, phone, channel, display_name, password_hash, otp_hash, attempts, expires_at)
...
-- name: GetSignupVerificationByPhone :one
SELECT * FROM signup_verifications WHERE phone = $1;
