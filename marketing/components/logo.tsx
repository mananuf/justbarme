...
export function Logo({ className = "w-8 h-8", style }: { className?: string; style?: CSSProperties }) {
  return (
    <svg viewBox="0 0 1000 1000" fill="currentColor" className={className} style={style} aria-hidden="true">
      <path d="M498.5,23.3C235.9,23.3,23,236.2,23,498.8v0C23,751.4,220,958,468.8,973.3v-202L108.2,425.5h768.7L524.3,770.8v202.8
